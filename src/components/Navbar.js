    ...
    >
      <Container>
        <Navbar.Brand href="/" className="d-flex">
          {/* <img src={logo} className="img-fluid logo" alt="AR" /> */}
          <strong className="purple" style={{ fontSize: "40px" }}>
            AR
          </strong>
        </Navbar.Brand>
        <Navbar.Toggle
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className="ms-auto" defaultActiveKey="#home">
            ...
            <Nav.Item>
              <Nav.Link href="#education" onClick={() => updateExpanded(false)}>
                <BsBook style={{ marginBottom: "2px" }} /> Education
              </Nav.Link>
            </Nav.Item>
